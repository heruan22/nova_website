...
export default function CasesPage() {
  ...
  const galleryCases = useMemo(() => [
    { id: 's1', category: 'steel', title: '热卷', image: '/images/products/steel-plate.jpg' },
    { id: 's2', category: 'steel', title: '彩涂卷', image: '/images/products/wire-rod.jpeg' },
    { id: 's3', category: 'steel', title: '热轧钢板', image: '/images/products/production-line.jpg' },
    { id: 's4', category: 'steel', title: '盘条', image: '/images/products/refrigeration.jpg' },
    { id: 's5', category: 'steel', title: '型钢', image: '/images/products/grain.jpg' },
    { id: 's6', category: 'steel', title: '镀锌管', image: '/images/products/grain.jpg' },
    { id: 's7', category: 'steel', title: '大口径无缝管', image: '/images/products/grain.jpg' },
    { id: 's8', category: 'steel', title: '钢轨', image: '/images/products/grain.jpg' },
    { id: 's9', category: 'steel', title: '钢结构', image: '/images/products/grain.jpg' },
    { id: 't1', category: 'ton-bags', title: '石油焦', image: '/images/products/additives.jpg' },
    { id: 't2', category: 'ton-bags', title: '兰炭', image: '/images/products/dump-truck.jpg' },
    { id: 't3', category: 'ton-bags', title: '化肥', image: '/images/products/crane.jpg' },
    { id: 't4', category: 'ton-bags', title: '元明粉', image: '/images/products/plastic-pellets.jpg' },
    { id: 't5', category: 'ton-bags', title: '食品添加剂', image: '/images/products/plastic-pellets.jpg' },
    { id: 't6', category: 'ton-bags', title: 'PVC', image: '/images/products/plastic-pellets.jpg' },
    { id: 'v1', category: 'vehicle', title: '自卸车', image: '/images/products/彩涂卷.jpg' },
    { id: 'v2', category: 'vehicle', title: '油罐车', image: '/images/products/hot-rolled-coil.jpg' },
    { id: 'v3', category: 'vehicle', title: '半挂车', image: '/images/products/hot-rolled-coil.jpg' },
    { id: 'v4', category: 'vehicle', title: '客车', image: '/images/products/hot-rolled-coil.jpg' },
    { id: 'v5', category: 'vehicle', title: '起重机', image: '/images/products/hot-rolled-coil.jpg' },
    { id: 'v6', category: 'vehicle', title: '挖掘机', image: '/images/products/hot-rolled-coil.jpg' },
    { id: 'e1', category: 'equipment', title: '变压器', image: '/images/products/hot-rolled-coil.jpg' },
    { id: 'e2', category: 'equipment', title: '锅炉', image: '/images/products/hot-rolled-coil.jpg' },
    ...
    { id: 'b2', category: 'bulk-cargo', title: '煤炭', image: '/images/products/hot-rolled-coil.jpg' },
    ...
    { id: 'o1', category: 'others', title: '胶合板', image: '/images/products/hot-rolled-coil.jpg' },
